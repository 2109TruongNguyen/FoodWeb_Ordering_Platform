        ...
        <div class="content">
            ...
            <form style="margin-left: 10%" class="form-horizontal col-sm-6" action="MainControllerAdmin?action=createFood" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input required type="text" class="form-control" name="foodName" placeholder="Tên sản phẩm">
                    </div>
                </div>
                <div class="form-group">
                    <label for="category-ID" class="col-sm-2 control-label">ID danh mục:</label>
                    <div class="col-sm-10">
                        <input required type="number" min="1" class="form-control" name="foodCategory" placeholder="ID danh mục">
                    </div>
                </div>
                <div class="form-group">
                    <label for="origin" class="col-sm-2 control-label">Xuất xứ:</label>
                    <div class="col-sm-10">
                        <input required type="text" class="form-control" name="foodOrigin" placeholder="Xuất xứ">
                    </div>
                </div>
                <div class="form-group">
                    <label for="price" class="col-sm-2 control-label">Giá tiền:</label>
                    <div class="col-sm-10">
                        <input required type="number" class="form-control" name="foodPrice" placeholder="Giá tiền">
                    </div>
                </div>
                <div class="form-group">
                    <label for="description" class="col-sm-2 control-label">Mô tả:</label>
                    <div class="col-sm-10">
                        <textarea required class="form-control" id="description" name="description" rows="4" placeholder="Mô tả sản phẩm"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="wayCooking" class="col-sm-2 control-label">Cách làm:</label>
                    <div class="col-sm-10">
                        <textarea required class="form-control" id="wayCooking" name="wayCooking" rows="4" placeholder="Cách làm"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="file" class="col-sm-2 control-label">Chọn file:</label>
                    <div class="col-sm-10">
                        <input required class="form-control" type="file" accept=".jpg, .png" id="file" name="file" onchange="previewImage(event)">
                    </div>
                </div>
                <div class="form-group">
