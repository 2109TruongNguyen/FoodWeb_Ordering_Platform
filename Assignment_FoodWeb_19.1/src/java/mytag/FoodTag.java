        ...
        try {
            ...
            if (f.getPrice() > 0) {
                ...
                if (addPlan == 1) {
                    ...
                    out.print("<a class='button btn btn-warning' "
                            + "href='MainController?action=optionsEdit&ActionEdit=addFood&foodId=" + f.getId() + "' "
                            + "role='button'>Thêm vào</a>");
                }
                out.print("</div>");
                out.print("</div>");
                out.print("</div>");
...
//            <v:formatNumber value= "${i.price}" type="currency" currencySymbol="VND"/>
    ...
    public void setAddPlan(int addPlan) {
